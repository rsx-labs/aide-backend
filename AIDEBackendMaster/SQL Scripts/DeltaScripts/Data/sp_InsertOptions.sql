...
INSERT INTO [dbo].[OPTION]([ModuleID],[FunctionID],[Description],[Value])
	VALUES	(1, 1,	'Email Notification - Allow sending of email notification [0=False 1=True]', '0'),
			(2,	2,	'Missing Resource Plan - Checking Time config [Time]',	'10:00:00 PM'),
			...
			(3,	3,	'Missing Weekly Report - Checking Date and time config [Day of week, Time]',	'1,10:00:00 PM'),
			...
			(6,	13,	'Update Contact List - Checking datetime config [Day, Time]',	'1,06:00:00 AM'),
			...
			(17, 14, 'Update Skill Matrix - Checking datetime config [Day, Time]',	'1,06:00:00 AM'),
