...
BEGIN
	...
	SELECT TOP 1 @DATEVALUE = WEEKDATE FROM WORKPLACE_AUDIT_DAILY WHERE FY_WEEK = @FY_WEEK
...
INSERT INTO #SummaryDailyAuditor2
	...
	INNER JOIN WORKPLACE_AUDIT_DAILY WAD  ON SDA.WEEKDATESCHED = WAD.WEEKDATE ORDER BY SDA.WEEKDATESCHED ASC
