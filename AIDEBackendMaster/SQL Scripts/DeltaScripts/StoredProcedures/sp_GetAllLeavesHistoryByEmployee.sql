...
(
	...
	R.STATUS = S.STATUS WHERE S.STATUS_ID in (7,9) and R.EMP_ID = @EMP_ID and R.STATUS not in (7) and R.DATE_ENTRY < CONVERT(DATE, GETDATE()) 
	or R.STATUS_CD = 0 and S.STATUS_ID in (7,9) 
),
 CTEDATES1
AS
(
