    ...
    class clsCommendationsSql : DataLayerBase
    {
        ...
        public bool InsertCommendations(clsCommendations businessObject)
        {
            ...
            try
            {
                ...
                sqlCommand.Parameters.Add(new SqlParameter("@REASON", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.REASON));
