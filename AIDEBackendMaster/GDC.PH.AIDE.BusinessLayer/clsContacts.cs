...
namespace GDC.PH.AIDE.BusinessLayer
{
    public class clsContacts : BusinessObjectBase
    {
        ...
        internal override void AddValidationRules()
        {
            ...
            ValidationRules.AddRules(new Validation.ValidateRuleStringMaxLength("CEL_NO", "CEL_NO", 15));
            ValidationRules.AddRules(new Validation.ValidateRuleStringMaxLength("HOMEPHONE", "HOMEPHONE", 15));
